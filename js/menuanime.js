...
function putcontent(i)
{
	...
	content[4] = "<h3>Procedural Abstract VFX</h3>These are class projects from my CGMA Abstract Effects Class. The class is a well rounded lesson with  fundamentals in copy stamping, noise effects, vex and point cloud lookup, creatinbg an abstract growth effect etc.";
	content[5] = "Shaders are written for Unity and created using the shader-graph for Unity 2018 & above versions and coded as Surface Shaders using <i>Cg</i> for older versions.<br><br><hr><br><h3>Graphics</h3><ol><li>Texture Mapping and modelling</li><li>Combine into One Mesh</li><li>Vectors and Normals with Shadow projection</li><li>Parenting and Translation</li></ol><br>Graphics Codex - Projects<br><i>Projects from Morgan Mcguire's Graphics Codex</i><br><ol><li>Cubes: Transformations</li><li>Geometry Meshes - Generate new 3D models as indexed triangle meshes for mathematical shapes, glasses, and procedural terrain.</li></ol>";
