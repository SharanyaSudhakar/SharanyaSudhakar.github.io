...
function putcontent(i)
{
	...
	content[3] = "<h3>Procedural Modeling</h3>These are class projects from my CGMA procedural modelling class. All of them are created in a learning environment with some enhancements and tuneups which are personal.<br><br>All tuneups and variations are explained in the VARIATIONS section under each project. Some have my initial planning and ideas listed as these are yet to be completed.<br><br> Software used: <h4>HOUDINI</h4>";
